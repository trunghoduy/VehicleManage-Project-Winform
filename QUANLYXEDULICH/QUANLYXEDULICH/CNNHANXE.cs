...
{
    public partial class CNNHANXE : Form
    {
        ...
        private void ketnoicsdl()
        {
            ...
            string sql = "select * from NHANXE ";  // lay het du lieu trong bang loai xe
...
#endregion
        #region load form
        private void CNNHANXE_Load(object sender, EventArgs e)
        {
            ketnoicsdl();
        }
        #endregion
        ...
        public void loadData()
        {
            ...
            da = new SqlDataAdapter("select * from NHANXE ", conn);
            dt = new DataTable();
            dt.Clear();
            da.Fill(dt);
            dataGridView1.DataSource = dt; //đổ dữ liệu vào datagridview
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.tbxNgayNhan.Text = dataGridView1.Rows[r].Cells[4].Value.ToString();
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    this.tbxNgayNhan.Text = dataGridView1.Rows[r].Cells[4].Value.ToString();
                    this.tbxTinhTrang.Text = dataGridView1.Rows[r].Cells[5].Value.ToString();
                    cmd.CommandText = System.String.Concat("delete from NHANXE where SoBB ='" + this.tbxSoBB.Text + "' ");
                    cmd.CommandType = CommandType.Text;
                    DialogResult traloi;
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (them)
            {
                try
                {
                    ...
                    else if (tbxNgayNhan.Text.ToString() == "")
                    {
                        MessageBox.Show("Bạn chưa nhập ngày giao nhận hoặc tồn tại, nhập lại !", "Thông báo !", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        tbxNgayNhan.Focus();
                    }
                    ...
                    else
                    {
                        ...
                        cmd.Connection = conn;
                        cmd.CommandType = CommandType.Text;
                        cmd.CommandText = System.String.Concat("insert into NHANXE values(" + "N'" + this.tbxSoBB.Text.ToString() + "'," + "N'" + this.tbxBienSoXe.Text.ToString() + "',N'"
                                                                + this.tbxTenXe.Text.ToString() + "',N'" + this.tbxTenKhachHang.Text.ToString() + "',N'"
                                                                + this.tbxNgayNhan.Text.ToString() + "',N'" + this.tbxTinhTrang.Text.ToString() + "')");
                        cmd.CommandType = CommandType.Text;
                        cmd.ExecuteNonQuery();
                        loadData();
            ...
            if (!them)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        this.tbxSoBB.Text = dataGridView1.Rows[r].Cells[0].Value.ToString();
                        // câu lệnh truy vấn
                        cmd.CommandText = System.String.Concat("update NHANXE set BienSoXe=N'" + this.tbxBienSoXe.Text.ToString()
                                                               + "',TenXe=N'" + this.tbxTenXe.Text.ToString() + "',TenKH=N'" + this.tbxTenKhachHang.Text.ToString()
                                                               + "',NgayNhan=N'" + this.tbxNgayNhan.Text.ToString() + "',TinhTrangXe=N'" + this.tbxTinhTrang.Text.ToString()
