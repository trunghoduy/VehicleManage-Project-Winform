...
{
    public partial class CNXESUCO : Form
    {
        ...
        private void ketnoicsdl()
        {
            ...
            string sql = "select * from SUCO ";  // lay het du lieu trong bang loai xe
...
#endregion
        #region load form
        private void CNXESUCO_Load(object sender, EventArgs e)
        {
            ketnoicsdl();
        }
#endregion
        ...
        public void loadData()
        {
            ...
            da = new SqlDataAdapter("select * from SUCO ", conn);
            dt = new DataTable();
            dt.Clear();
            da.Fill(dt);
            dataGridView1.DataSource = dt; //đổ dữ liệu vào datagridview
              //xóa dữ liệu trong các ô
            this.tbxMaSuCo.ResetText();
            this.tbxBienSoXe.ResetText();           
            this.tbxTenXe.ResetText();
            this.tbxTenSuCo.ResetText();
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.tbxMaSuCo.Text = dataGridView1.Rows[r].Cells[0].Value.ToString();
                ...
                this.tbxTenSuCo.Text = dataGridView1.Rows[r].Cells[3].Value.ToString();
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    this.tbxTenXe.Text = dataGridView1.Rows[r].Cells[2].Value.ToString();
                    this.tbxTenSuCo.Text = dataGridView1.Rows[r].Cells[3].Value.ToString();
                    cmd.CommandText = System.String.Concat("delete from SUCO where  MaSC='" + this.tbxMaSuCo.Text + "' ");
                    cmd.CommandType = CommandType.Text;
                    DialogResult traloi;
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (them)
            {
                try
                {
                    if (tbxMaSuCo.Text.ToString() == "")
                    {
                        MessageBox.Show("Bạn chưa nhập mã sự cố hoặc tồn tại, nhập lại !", "Thông báo !", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        tbxMaSuCo.Focus();
                    }
                    ...
                    else if (tbxTenSuCo.Text.ToString() == "")
                    {
                        MessageBox.Show("Bạn chưa nhập tên sự cố hoặc tồn tại, nhập lại !", "Thông báo !", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        tbxTenSuCo.Focus();
                    }
                    else
                    {
                        ...
                        cmd.Connection = conn;
                        cmd.CommandType = CommandType.Text;
                        cmd.CommandText = System.String.Concat("insert into SUCO values(" + "N'" + this.tbxMaSuCo.Text.ToString() + "'," + "N'" + this.tbxBienSoXe.Text.ToString() + "',N'"
                                                                + this.tbxTenXe.Text.ToString() + "',N'" + this.tbxTenSuCo.Text.ToString() + "')");
                        cmd.CommandType = CommandType.Text;
                        cmd.ExecuteNonQuery();
                        loadData();
            ...
            if (!them)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        this.tbxMaSuCo.Text = dataGridView1.Rows[r].Cells[0].Value.ToString();
                        // câu lệnh truy vấn
                        cmd.CommandText = System.String.Concat("update SUCO set BienSoXe=N'" + this.tbxBienSoXe.Text.ToString()
                                                               + "',TenXe=N'" + this.tbxTenXe.Text.ToString() + "',TenSC=N'" + this.tbxTenSuCo.Text.ToString()
                                                               + "'where MaSC ='" + this.tbxMaSuCo.Text + "' ");
                        cmd.CommandType = CommandType.Text;
                        cmd.ExecuteNonQuery();
                        loadData();
